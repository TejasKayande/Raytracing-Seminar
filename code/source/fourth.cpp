...
Sphere sphere(Vec3(0.0f, 0.0f, 0.0f), 0.3f, Color(1.0, 1.0, 1.0f));
Vec3 camera_pos(0.0f, 0.0f, -1.0f);

// NOTE(Tejas): direction of light (it is actually inversed!)
Vec3 light_dir = Vec3::normalize(Vec3(-0.4f, -0.5f, -0.2f));
...
int main(void) {
    ...
    if (initImage(WIDTH, HEIGHT, "images/fourth4.ppm") != 0) return -1;
